...
description: Configure repository-level defaults used by RC medical research skills.
...
2. Ask which labels represent triage states for the RC workflow in this repository.
3. Ask where generated research notes, evidence summaries, and other docs should be saved.
